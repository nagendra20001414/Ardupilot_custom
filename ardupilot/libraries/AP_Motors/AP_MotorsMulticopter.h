...
#define AP_MOTORS_MIX_MIN_DEFAULT       0.05f   // minimum throttle mix, 1 - 0.05 = 0.95, to check if the throttle is more than 95%
#define AP_MOTORS_MIX_MID_DEFAULT       0.1f    // manual throttle mix
#define AP_MOTORS_MIX_MAX_DEFAULT       0.1f    // maximum throttle mix default
#define AP_MOTORS_THR_WARN_DEFAULT      0.1f    // output warning threshold
...
protected:
    ...
    // motor output warning threshold
    AP_Float            _thr_warn_threshold;
