...
const AP_Param::GroupInfo AP_MotorsMulticopter::var_info[] = {
    ...
    // @Param: THR_WARN
    // @DisplayName: Throttle warning limit
    // @Description: When checking for a motor failure, The treshold we set for the the throttle to be higher than. It is usually between 0.9 to 0.95
    // @Rannge: 0 1
    // @Units: 1
    // @User: Advanced
    AP_GROUPINFO("THR_WARN", 42, AP_MotorsMulticopter, _thr_warn_threshold, AP_MOTORS_THR_WARN_DEFAULT),
