...
public:
    ...
    // checking for adverse motor output for motors 1 and 2 in a quad X or an extended period
    void                check_failing_motors12();
...
protected:
    ...
    int num_cycles_check = 40;      // number of cycles used for checking
    
    float thr_remaining = 0.75;    // used to check if remaining motors are below this number
};
