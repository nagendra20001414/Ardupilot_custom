...
bool Copter::ModeMotorFailure12::init(bool ignore_checks)
{
...
void Copter::ModeMotorFailure12::run()
{
...
void Copter::set_mode_mf12(){
    set_mode(MOTOR_FAILURE12, MODE_REASON_UNKNOWN);
