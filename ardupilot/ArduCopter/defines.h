...
enum control_mode_t {
    ...
    MOTOR_FAILURE12 =   25, // custom mode in which motor 1 or motor 2 suffered a catastrophic failure in Quad-X drone
    MF_INDUCING1    =   26, // custom mode in which we induce failure to a motor(motor-1)
};
