...
Copter::Mode *Copter::mode_from_mode_num(const uint8_t mode)
{
    ...
    switch (mode) {
        ...
        case MOTOR_FAILURE12:
            ret = &mode_motorfailure12;
            break;
            
        case MF_INDUCING1:
            ret = &mode_mfinducing1;
            break;
...
void Copter::notify_flight_mode() {
    ...
    if (strcmp(flightmode->name4(), "MF12") == 0){
        AP_Notify::flags.is_mode_mf12 = true;
        AP_Notify::flags.is_mode_mfi1 = false;
    }
    else{
        AP_Notify::flags.is_mode_mf12 = false;
        if (strcmp(flightmode->name4(), "MFI1") == 0){
            AP_Notify::flags.is_mode_mfi1 = true;
        }else{
            AP_Notify::flags.is_mode_mfi1 = false;
        }
    }
