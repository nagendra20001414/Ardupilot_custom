...
class ModeMotorFailure12 : public Mode{
...
protected:
    ...
    const char *name() const override { return "MOTORFAILURE12"; }
    const char *name4() const override { return "MF12"; }
...
class ModeMFInducing1 : public Mode {
...
protected:
    ...
    const char *name() const override { return "MOTORFAILUREINDUCING1"; }
    const char *name4() const override { return "MFI1"; }
